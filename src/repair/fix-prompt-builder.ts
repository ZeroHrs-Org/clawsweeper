...
function renderTargetSpecificRepairGuidance(fixArtifact: LooseRecord) {
  ...
  return [
    ...
    "- keep the Codex edit pass narrow: after the code change, focused changed-surface tests, and Android proof files are complete, return; do not spend the edit pass running broad `pnpm run diff:checks` repeatedly for ZeroHrs issue implementation, because ClawSweeper runs its configured validation after checkpointing the patch;",
