...
function renderTargetSpecificRepairGuidance(fixArtifact: LooseRecord) {
  ...
  return [
    ...
    "- the proof manifest must state the issue-specific reproduction route, refs/SHAs or branch names used for before and after, seed/mock commands, and any blocker; set `status` to `completed` only when both before and after media are valid;",
